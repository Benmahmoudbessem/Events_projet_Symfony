...
{
    $query = $em->createQuery("select i from App\Entity\Inscription i join i.event e where i.client= :idc");
    $query->setParameter('idc', $id);
    $inscription = $query->getResult();

    return $this->render('/client/events.html.twig', ['listeI' => $inscription]);
}
